(function() {
  ...
  Complaints = (function(superClass) {
    ...
    Complaints.prototype.retrieveAll = function(domain, limit, body, fn) {
      if (fn == null) {
        fn = null;
      }
      ...
      this.debug("Complaints::retrieveAll(" + domain + "," + body + "," + limit + ")");
      return this.get(domain + "/complaints?limit=" + limit, body, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
    ...
    Complaints.prototype.remove = function(domain, address, fn) {
      ...
      return this["delete"](domain + "/complaints/" + address, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
    ...
    Complaints.prototype.removeAll = function(domain, fn) {
      ...
      return this["delete"](domain + "/complaints", function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
