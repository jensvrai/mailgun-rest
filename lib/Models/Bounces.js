(function() {
  ...
  Bounces = (function(superClass) {
    ...
    Bounces.prototype.retrieveAll = function(domain, limit, body, fn) {
      if (fn == null) {
        fn = null;
      }
      ...
      this.debug("Bounces::retrieveAll(" + domain + "," + body + "," + limit + ")");
      return this.get(domain + "/bounces?limit=" + limit, body, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
    ...
    Bounces.prototype.remove = function(domain, address, fn) {
      ...
      return this["delete"](domain + "/bounces/" + address, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
    ...
    Bounces.prototype.removeAll = function(domain, fn) {
      ...
      return this["delete"](domain + "/bounces", function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
