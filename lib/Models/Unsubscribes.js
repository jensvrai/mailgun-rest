(function() {
  ...
  Unsubscribes = (function(superClass) {
    ...
    Unsubscribes.prototype.retrieveAll = function(domain, body, fn) {
      if (fn == null) {
        fn = null;
      }
      this.debug("Unsubscribes::retrieveAll(" + domain + "," + body + ")");
      return this.get(domain + "/unsubscribes", body, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
    ...
    Unsubscribes.prototype.remove = function(domain, address, fn) {
      ...
      return this["delete"](domain + "/unsubscribes/" + address, body, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
    ...
    Unsubscribes.prototype.removeAll = function(domain, fn) {
      ...
      return this["delete"](domain + "/unsubscribes", body, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
